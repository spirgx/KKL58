Public Class frmYearView
    ...
    Private Sub ButtonQuery_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonQuery.Click
        ...
        QueryStr = "SELECT CONVERT(varchar(7), TimeStamp, 120 ) as '日期', convert(decimal(8,1), AVG(IN_PH)) as '進流水酸鹼值', " & _
                            ...
                            "FROM (select *, Year(TimeStamp) as Y, Month(TimeStamp) as M From "
        ...
        QueryStr = QueryStr & " WHERE Year(TimeStamp) = '" & StartDatePicker.Value.Year.ToString & "' "
        QueryStr = QueryStr & ") t GROUP BY Y, M, CONVERT(varchar(7), TimeStamp, 120) Order by CONVERT(varchar(7), TimeStamp, 120)"
    ...
    Private Sub ButtonPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonPrint.Click
        ...
        Dim YearViewReport As New frmYearViewReport

        YearViewReport.MdiParent = frmMain

        YearViewReport.FormBorderStyle = Windows.Forms.FormBorderStyle.Fixed3D
        YearViewReport.WindowState = FormWindowState.Normal


        QueryStr = "SELECT CONVERT(varchar(7), TimeStamp, 120 ) as TimeStamp, AVG(IN_PH) as IN_PH, " & _
        ...
        paras(0) = New Microsoft.Reporting.WinForms.ReportParameter("Title", "金門酒廠" & AreaName & "廢水監測系統年報表")
        ...
        YearViewReport.ReportViewer.LocalReport.SetParameters(paras)

        YearViewReport.ReportViewer.LocalReport.DataSources(0).Value = QuerySet.Tables("ReportSet")
        YearViewReport.ReportViewer.RefreshReport()
    ...
    Private Sub frmYearView_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
